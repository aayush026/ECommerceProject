    ...
    <a class="nav-link" href="#!" data-toggle="modal" data-target="#cart">
        ...
        <span class="ml-0 cart-items" style="font-size: 20px;">(0)</span>
            ...
            %>
             <li class="nav-item active">
    <%
        String userType = user1 != null ? user1.getUserType() : "";
        String userName = user1 != null ? user1.getUserName() : "";
    %>
    <a class="nav-link" href="<%= userType.equals("admin") ? "admin.jsp" : "normal.jsp" %>">
        <%= userName %>
    </a>
</li>
